...
semordnilap: semordnilap.c
	...
	! test -f /usr/lib/x86_64-linux-gnu/libenchant.so || gcc -Wall -I"/usr/include/enchant" semordnilap.c /usr/lib/x86_64-linux-gnu/libenchant.so -o semordnilap # Ubuntu
